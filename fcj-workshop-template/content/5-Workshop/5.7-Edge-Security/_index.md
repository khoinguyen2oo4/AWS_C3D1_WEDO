...
![Configure CloudFront Origin](/AWS_C3D1_WEDO/images/5-Workshop/5.7-Edge-Security/cloudfront-origin.jpg)
...
![Enable WAF Security for CloudFront](/AWS_C3D1_WEDO/images/5-Workshop/5.7-Edge-Security/cloudfront-waf.png)

* Scroll to the bottom, double-check all information in the **Review and create** section, and click **Create distribution**.
![Confirm CloudFront Creation](/AWS_C3D1_WEDO/images/5-Workshop/5.7-Edge-Security/cloudfront-create.jpg)
