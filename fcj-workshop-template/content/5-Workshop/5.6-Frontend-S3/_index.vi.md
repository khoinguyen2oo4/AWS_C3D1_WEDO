...
![Build mã nguồn Frontend](/AWS_C3D1_WEDO/images/5-Workshop/5.6-Frontend-S3/frontend-build.jpg)
...
* Bấm **Create bucket**.
![Tạo S3 Bucket](/AWS_C3D1_WEDO/images/5-Workshop/5.6-Frontend-S3/s3-create.jpg)

* Mở Bucket vừa tạo, nhấn nút **Upload** và kéo thả toàn bộ nội dung trong thư mục `dist` lên S3.
![Upload Frontend lên S3](/AWS_C3D1_WEDO/images/5-Workshop/5.6-Frontend-S3/s3-upload-success.png)
...
![Cập nhật S3 Bucket Policy](/AWS_C3D1_WEDO/images/5-Workshop/5.6-Frontend-S3/s3-policy.png)
...
![Kích hoạt Static Hosting](/AWS_C3D1_WEDO/images/5-Workshop/5.6-Frontend-S3/s3-static-hosting.png)
...
![Kết quả Website hoạt động](/AWS_C3D1_WEDO/images/5-Workshop/5.6-Frontend-S3/s3-result.jpg)